...
namespace Program
{
    ...
    C2, C5, C6 (Same Color of this sets)         KQB
    */
    // Sets
    /*
    ...
    */
    ...
    class FourColorAlgo
    {
        ...
        static void Main(string[] args)
        {
            ...
            game.playersHands[1].Add("C2_Green");
            game.playersHands[1].Add("C2_Yellow");

            game.playersHands[1].Add("C6");
            game.playersHands[1].Add("C6_Green");
            ...
            List<string> focustile = game.playersHands[4];
            ...
            Console.WriteLine($"AFTER LOGIC : { game.WinCondition(4) }" );
        }
